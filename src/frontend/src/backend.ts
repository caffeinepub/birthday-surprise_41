...
export class Backend implements backendInterface {
    ...
    async getBirthdayDate(): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.getBirthdayDate();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async setBirthdayDate(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setBirthdayDate(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
